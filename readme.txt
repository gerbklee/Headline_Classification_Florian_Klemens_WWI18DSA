...
Die heruntergeladene Annotated Data.csv bitte auf der obersten Ebene des main branch ablegen.

Die Originaldaten wurden von https://www.kaggle.com/therohk/million-headlines bezogen.

Um das Frontend nutzen zu können werden folgende Libraries benötigt:
- flask
- flask_bootstrap
- newsapi-python
- pandas

Um die Anwendung zu starten App.py in Visual Studio Code ausführen. Anschließend im Browser localhost:5000 besuchen um die Anwendung zu nutzen.
